...
Random Forest Train/Test Split Ratio Analysis for MFA Prediction

This script evaluates how different train/test split ratios affect RF model performance.
...
for predCol in ["MFA", "desMFA"]:
    ...
    for train_ratio in np.arange(0.05, 0.96, 0.05):
        ...
        output_line = "{:s} {:d} {:.2f} {:d} {:.3f} {:.3f} {:.3f} {:.3f}".format(
            predCol, whichTempl, train_ratio, n_trees, me, mae, rmse, r2
        )
