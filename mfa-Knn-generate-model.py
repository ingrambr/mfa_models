...
KNN Model Generator for MFA Prediction

This script trains KNN model for MFA prediction.
...
print("Variable Template Neighbors ME MAE RMSE R2 P1 P2 P3 EW LW CW")
...
for whichTempl in [0, 1, 2, 3]:
    ...
    for predCol in ["MFA", "desMFA"]:
        ...
        # Dictionary to store results for later saving
        results = {}
        ...
        output_line = "{:s} {:d} {:d} {:.3f} {:.3f} {:.3f} {:.3f}".format(
            predCol, whichTempl, neighbors, me, mae, rmse, r2
        )
